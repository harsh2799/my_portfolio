...
const Experiences = () => {
    ...
    return <div id="experiences" className='flex flex-col items-center pt-16 md:pt-20 lg:flex-row'>
        <div className='introduction flex-1 p-2 lg:pl-10 flex justift-center flex-col text-center sm:w-3/4 lg:w-3/5 lg:pr-12 lg:text-left'>
            ...
            <p className='pt-6 text-xl leading-relaxed text-justify mb-10 intro-text'>
            ...
            <div className='flex flex-row gap-4 items-center'>
                <p className='font-semibold text-md intro-text'>Get to Know Me: </p>
                {
